...
<div class="container-fluid">
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="<?= site_url('/AdminController/anggota') ?>"><i class="fas fa-arrow-left"></i></a>
            </div>
            <h1>Member</h1>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-body col">
            <form action="/AdminController/updateAnggota/<?= $member['id'] ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="nohp" name="nohp" class="form-control" value="<?= $member['nomor_telepon'] ?>">
                </div>
                <div class="form-group">
